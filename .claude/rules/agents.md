...
| tdd-guide | [已废弃] 由 subagent-driven-development skill 内部 general-purpose + implementer-prompt.md 替代 |
| code-reviewer | [已废弃] 由 subagent-driven-development skill 内部 general-purpose + code-quality-reviewer-prompt.md 替代 |
...
| e2e-runner | [已废弃] 由 subagent-driven-development skill 内部 implementer subagent 替代 |
